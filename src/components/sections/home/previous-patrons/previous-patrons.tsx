...
import { LogoSection } from '@/components/sections/home/previous-patrons/patrons-tier'
import { Spotlight } from '@/components/twilight/spotlight/spotlight'

import { LINKS, PATRONS, PATRONS_DATA, TIER_NAME, TIER_PROPERTIES } from '@/content/previousconstants'

export function PreviousPatrons() {
  return (
