  ...
  ({ className, ...props }, ref) => {
    ...
    // />
      ...
      >
        <textarea
          className={cn(
            `flex min-h-[80px] w-full border dark:bg-background text-black dark:text-white shadow-input rounded-sm px-3 py-2 text-sm  file:border-0 file:bg-transparent
