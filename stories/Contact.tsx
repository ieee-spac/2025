    ...
    <div className="px-3 md:px-8 max-w-3xl mx-auto space-y-10 overflow-none my-20">
      ...
      <div className="mockup-browser border border-base-300">
        ...
        <div className="mockup-browser-toolbar">
          <p className="input border border-base-300">
          Get in touch :)
          </p>
        </div>

        {/* Form Container */}
          <form action="" className="space-y-5 w-full flex flex-col justify-center items-center px-4 py-16 border-t border-base-300">
            {/* Full Name */}
            ...
            {/* Submit Button */}
            <button className="btn btn-outline btn-accent btn-wide text-base">
              Submit
            </button>
          </form>
      </div>
