...
export const Main = () => {
  return (
    ...
    <div className="min-h-screen flex justify-center items-center p-4 w-full dark:bg-black bg-white dark:bg-grid-green-600/[0.5] bg-grid-black/[0.2]">
      ...
      {/* Center box */}
      <main className="flex flex-col justify-center items-center space-y-4 h-fit border border-secondary px-4 py-8 md:px-20 md:py-16 rounded-lg transition-all ease-in-out duration-300 group hover:shadow-[0_0px_15px_rgba(0,202,255,1)] backdrop-blur-xs">
        <Image
          src={logo}
